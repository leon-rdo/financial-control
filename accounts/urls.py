...
urlpatterns = [
    ...
    path("entidades/criar-modal/", EntityModalCreateView.as_view(), name="entity_create_modal"),
    ...
    path("metodos-de-pagamento/criar-modal/", PaymentMethodModalCreateView.as_view(), name="payment_method_create_modal"),
